 ...
 *
 */
  public PrivateCustomerManagerVip(String fullname, String department, 
 ...
 * that the Private Customer Manager of Vip clients will gain.
 */
  @Override
  ...
  public void custMenu() {
    ...
    switch (option) {
      ...
      case 2:
        ...
        break;
      case 3:
    	  int size = Private.pCMVip.size();
          if (size == 0) {
            System.out.println("Customers list: empty ");
          }
          for (int i = 0; i < size; i++) {
            Private p = Private.pCMVip.get(i);
 ...
 *that Private Customer Manager of Vip clients can have.
 */
  @Override
  public void getMenu() {
    for (;;) {
