...
public class LoanManager extends Employee {
	...
	public LoanManager(String fullname, int idEmployee, String department, String email, double salary, Date firstDate,
	...
	public double computeBonus() {
		...
		for (int i = 0; i < employees.size(); i++) {
			...
			if (emp.getDepartment() == "Business Service Manager" || emp.getDepartment() == "Custumer Service Manager"
