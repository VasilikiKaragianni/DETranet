...
public class BusinessCustomerManagerDelays extends Employee {
	...
	public BusinessCustomerManagerDelays(String fullname, int idEmployee, String department, String email,
			double salary, String firstDate, int leaves, String username, String password, int overall) {
		...
		do {
			try {
				...
				case 1:
					...
					break;
				case 2:
					LoanManager.setGoals();
					break;
				case 3:
					LoanManager.computeBonus();
					break;
				case 4:
					leaves();
					break;
				case 5:
					BusinessCustomerManagerDelays.getNews();
					break;
				case 6:
					Main.main();
					break;
